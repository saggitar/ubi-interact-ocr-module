...
metadata = importlib_metadata.metadata('ubii-processing-module-ocr')
...
html_theme_options = {
    ...
    'github_repo': 'ubii-processing-module-ocr',
    'page_width': '75%'
}
...
intersphinx_mapping = {
    ...
    'framework': ('https://ubii-node-python.readthedocs.io/en/develop/', None)
}
